...
# # Query the temporary collection to get the start and end dates
# temp_data = temp_collection.find_one()
# start_date = temp_data['start_date']
# end_date = temp_data['end_date']

# # Print the retrieved start and end dates
# print(f"Start Date retrieved from temp_collection: {start_date}")
# print(f"End Date retrieved from temp_collection: {end_date}")
